    ...
    <div className="h-screen w-screen flex flex-col justify-center items-center">
      ...
      <div className='border rounded p-8 flex justify-between items-center max-w-2xl'>
        <div className='w-64 h-64 flex flex-col'>
          <img  src={firstPokemon.data?.sprites.front_default ?? fallback} alt={firstPokemon.data?.name} className='w-full'/>
          <div className="text-xl text-center capitalize mt-[-2rem]">{firstPokemon.data?.name}</div>
        </div>
        <div className='p-8'>Vs</div>
        <div className='w-64 h-64 flex flex-col'>
          <img  src={secondPokemon.data?.sprites.front_default ?? fallback} alt={secondPokemon.data?.name} className='w-full'/>
